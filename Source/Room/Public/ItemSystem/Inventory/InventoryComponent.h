...
public:
	...
	bool AddItemToInventory(UItemBase* NewItem, int32 Quantity);
	UFUNCTION(BlueprintCallable, Category = "Inventory")
...
private:
	bool AddStackableItem(UItemBase* NewItem, int32 Quantity);
	bool AddNonStackableItem(UItemBase* NewItem);
