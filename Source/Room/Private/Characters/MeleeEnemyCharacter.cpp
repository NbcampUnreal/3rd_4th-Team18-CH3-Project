...
void AMeleeEnemyCharacter::BeginPlay()
{
	...
	UE_LOG(LogTemp, Log, TEXT("[AI][MeleeEnemyCharacter] AI Character has been spawned"));
}
	...
	UPrimitiveComponent* OtherComp, int OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
	...
	if (ABaseProjectile* Projectile = Cast<ABaseProjectile>(OtherActor))
	{
		...
		if (Shooter && Shooter != this)
		{
			...
			{
				UE_LOG(LogTemp, Warning, TEXT("[AI][AMeleeEnemyCharacter] Bullet detected from same team. No tracking."));
			}
		}
	}
}
...
void AMeleeEnemyCharacter::TrackBulletShooter(AActor* BulletShooter)
{
	...
	{
		UE_LOG(LogTemp, Log, TEXT("[AI][MeleeEnemyCharacter] AIController NOT FOUND!"));
	}
}


void AMeleeEnemyCharacter::InitializeFromStaticData(const FStaticData* InStaticData)
{
	...
	if (!EnemyData)
	{
		UE_LOG(LogTemp, Error, TEXT("MeleeEnemyCharacter::InitializeFromStaticData: Failed to cast to FEnemyData."));
		return;
	}
